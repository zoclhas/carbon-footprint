        ...
        {currTab === "students" ? (
          ...
          <section className="mt-4">
              ...
              <CardHeader className="text-lg font-medium flex max-sm:flex-col justify-between gap-2 sm:items-center">
                ...
                <div className="flex max-md:flex-col sm:gap-4 text-base">
                  <h3>
                    <strong>Today&apos;s Emission: </strong>
                    <span className="justify-self-start">
                      {classDetails.emissions_stats.todays_emission.total} kg of
                      CO
                      <sub>2</sub>
                    </span>
                  </h3>
            ...
            <Card className="mt-4">
              <CardHeader className="text-lg font-medium flex max-sm:flex-col justify-between gap-2 sm:items-center">
                ...
                <div className="flex max-md:flex-col sm:gap-4 text-base">
                  <h3>
                    ...
                    <span className="justify-self-start">
                      {classDetails.emissions_stats.months_emission.total} kg of
                      CO
                      <sub>2</sub>
                    </span>
                  </h3>
              ...
              <CardBody>
                <canvas id="month-graph" ref={monthChartCanvas}></canvas>
              </CardBody>
              <CardFooter>
                <h4 className="text-base">
                  <strong>Highest emission: </strong>
              ...
              <CardHeader className="text-lg font-medium flex max-sm:flex-col justify-between gap-2 sm:items-center">
                ...
                <div className="flex max-md:flex-col sm:gap-4 text-base">
                  <h3>
                    ...
                    <span className="justify-self-start">
                      {classDetails.emissions_stats.years_emission.total} kg of
                      CO
                      <sub>2</sub>
                    </span>
                  </h3>
                  <h3>
                    ...
                    <span className="justify-self-start">
                      {classDetails.emissions_stats.years_emission.avg} kg of CO
                      <sub>2</sub>
                    </span>
                  </h3>
                </div>
